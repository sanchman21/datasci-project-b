...
def plot_metrics_afterfold(metrics, fold, epoch, save_dir="plots"):
    # Ensure the save directory exists
    os.makedirs(save_dir, exist_ok=True)
    ...
    plot_path = os.path.join(save_dir, f'fold_{fold}_epoch_{epoch}.png')
    plt.savefig(plot_path)
    print(f"Saved plot to {plot_path}")
    plt.close()  # Close the figure to avoid too many figures open during the loop


if __name__ == '__main__':
    csv_file_path = 'merged_master.csv'
    all_metrics = train_model(csv_file_path)
    # You can now do something with all_metrics like saving to a file or printing.
