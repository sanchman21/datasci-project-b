...
from dataset import CustomDataset, NEUTROPHIL_CSV_PATH, MONOCYTE_CSV_PATH, MONOCYTE_NEW_NORMALS_CSV_PATH, SEGMENTED_MONOCYTE_CSV_PATH
...
parser.add_argument('--data_type', type=str, default="monocyte_new_normals", help="image type to train the model on", 
                    choices=('neutrophil', 'monocyte', 'monocyte_new_normals', 'segmented_monocyte_new_normals'))
